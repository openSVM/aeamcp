...
class IdlLoader {
    ...
    static calculateIdlHash(idlContent) {
        return crypto.createHash('sha256').update(idlContent, 'utf8').digest('hex');
    }
    /**
...
class SolanaClient {
    ...
    constructor(config) {
        ...
        const rpcUrl = config.rpcUrl || web3_js.clusterApiUrl(this.cluster);
        this.connection = new web3_js.Connection(rpcUrl, this.commitment);
    }
    /**
    ...
    async initializePrograms() {
        ...
        try {
            ...
            const agentRegistryProgramId = new web3_js.PublicKey('AgentReg11111111111111111111111111111111111'); // placeholder
            const mcpRegistryProgramId = new web3_js.PublicKey('11111111111111111111111111111111'); // placeholder
            // Initialize programs
            this.agentRegistryProgram = new anchor.Program(agentRegistryIdl, this.provider);
            this.mcpRegistryProgram = new anchor.Program(mcpRegistryIdl, this.provider);
        }
        catch (error) {
...
})(exports.McpServerStatus || (exports.McpServerStatus = {}));
// Payment Flow Types
...
const TOKEN_MINTS = {
    mainnet: new web3_js.PublicKey('Cpzvdx6pppc9TNArsGsqgShCsKC9NCCjA2gtzHvUpump'),
    devnet: new web3_js.PublicKey('A2AMPLyncKHwfSnwRNsJ2qsjsetgo9fGkP8YZPsDZ9mE'),
};
// Program IDs (placeholders - to be updated with actual program IDs)
const PROGRAM_IDS = {
    agentRegistry: new web3_js.PublicKey('AgentReg11111111111111111111111111111111111'),
    mcpServerRegistry: new web3_js.PublicKey('11111111111111111111111111111111'), // TBD
};
...
class Validator {
    ...
    static validatePublicKey(key, fieldName) {
        try {
            return typeof key === 'string' ? new web3_js.PublicKey(key) : key;
        }
        catch (error) {
...
class AgentAPI {
    ...
    async registerAgent(data, stakingTier) {
        ...
        try {
            ...
            const [agentPda] = web3_js.PublicKey.findProgramAddressSync([
            ...
            const registerInstruction = await program.methods
                ...
                systemProgram: web3_js.PublicKey.default, // SystemProgram.programId
            })
                .instruction();
    ...
    async updateAgent(agentId, data) {
        ...
        try {
            ...
            const updateInstruction = await program.methods
                ...
                .instruction();
            const transaction = new web3_js.Transaction().add(updateInstruction);
            return await this.client.sendAndConfirmTransaction(transaction);
        }
        catch (error) {
    ...
    async deregisterAgent(agentId) {
        ...
        try {
            ...
            const deregisterInstruction = await program.methods
                ...
                .instruction();
            const transaction = new web3_js.Transaction().add(deregisterInstruction);
            return await this.client.sendAndConfirmTransaction(transaction);
        }
        catch (error) {
    ...
    async stakeForAgent(agentId, amount, tier) {
        ...
        try {
            ...
            const transaction = new web3_js.Transaction().add(stakingInstruction);
            return await this.client.sendAndConfirmTransaction(transaction);
        }
        catch (error) {
    ...
    async getStakingInfo(agentId) {
        try {
            ...
            // Derive staking PDA
            const program = this.client.getAgentRegistryProgram();
            const [stakingPda] = web3_js.PublicKey.findProgramAddressSync([
            ...
            return {
                ...
                tier: exports.AgentTier.Bronze, // placeholder
    ...
    parseAgentAccount(account, publicKey) {
        ...
        return {
            ...
            status: account.status || exports.AgentStatus.Pending,
            owner: account.owner || web3_js.PublicKey.default,
    ...
    getStakingAmountForTier(tier) {
        switch (tier) {
            case exports.AgentTier.Bronze:
                return CONSTANTS.BRONZE_TIER_STAKE;
            case exports.AgentTier.Silver:
                return CONSTANTS.SILVER_TIER_STAKE;
            case exports.AgentTier.Gold:
                return CONSTANTS.GOLD_TIER_STAKE;
            case exports.AgentTier.Platinum:
...
class McpAPI {
    ...
    async registerServer(data) {
        ...
        try {
            ...
            const [serverPda] = web3_js.PublicKey.findProgramAddressSync([
            ...
            const registerInstruction = await program.methods
                ...
                .instruction();
            const transaction = new web3_js.Transaction().add(registerInstruction);
            return await this.client.sendAndConfirmTransaction(transaction);
        }
        catch (error) {
    ...
    async updateServerStatus(serverId, status) {
        ...
        try {
            ...
            const updateStatusInstruction = await program.methods
                ...
                .instruction();
            const transaction = new web3_js.Transaction().add(updateStatusInstruction);
            return await this.client.sendAndConfirmTransaction(transaction);
        }
        catch (error) {
    ...
    parseServerAccount(account, publicKey) {
        ...
        return {
            ...
            version: account.version || '1.0.0',
            status: account.status || exports.McpServerStatus.Pending,
            owner: account.owner || web3_js.PublicKey.default,
            registrationSlot: BigInt(account.registrationSlot || 0),
            lastUpdateSlot: BigInt(account.lastUpdateSlot || 0),
...
class PrepaymentFlow {
    ...
    async createPrepayment(config) {
        ...
        try {
            ...
            const payerTokenAccount = await splToken.getAssociatedTokenAddress(tokenMint, payer, false, splToken.TOKEN_PROGRAM_ID);
            const recipientTokenAccount = await splToken.getAssociatedTokenAddress(tokenMint, recipient, false, splToken.TOKEN_PROGRAM_ID);
            ...
            const transferInstruction = splToken.createTransferInstruction(payerTokenAccount, recipientTokenAccount, payer, amount, [], splToken.TOKEN_PROGRAM_ID);
    ...
    async ensureRecipientTokenAccount(transaction, recipient, recipientTokenAccount, tokenMint) {
        try {
            ...
            if (!accountExists) {
                ...
                recipientTokenAccount, recipient, tokenMint, splToken.TOKEN_PROGRAM_ID);
...
class PayAsYouGoFlow {
    ...
    async createUsagePayment(config, serviceId, fromTimestamp) {
        ...
        try {
            ...
            await this.ensureRecipientTokenAccount(transaction, recipient, recipientTokenAccount, tokenMint);
            // Create transfer instruction
            const transferInstruction = splToken.createTransferInstruction(payerTokenAccount, recipientTokenAccount, payer, totalAmount, [], splToken.TOKEN_PROGRAM_ID);
            transaction.add(transferInstruction);
            // Set recent blockhash and fee payer
            const { blockhash } = await this._client.connection.getLatestBlockhash();
            transaction.recentBlockhash = blockhash;
...
class StreamPaymentFlow {
    ...
    async startStream(streamId) {
        ...
        try {
            ...
            const transaction = await this.createPaymentTransaction({
                method: exports.PaymentMethod.Stream,
                payer: stream.payer,
    ...
    async createRefundTransaction(stream, refundAmount) {
        try {
            ...
            const recipientTokenAccount = await splToken.getAssociatedTokenAddress(tokenMint, stream.recipient, false, splToken.TOKEN_PROGRAM_ID);
            const payerTokenAccount = await splToken.getAssociatedTokenAddress(tokenMint, stream.payer, false, splToken.TOKEN_PROGRAM_ID);
            // Create transfer instruction (from recipient back to payer)
            const transferInstruction = splToken.createTransferInstruction(recipientTokenAccount, payerTokenAccount, stream.recipient, refundAmount, [], splToken.TOKEN_PROGRAM_ID);
            transaction.add(transferInstruction);
            // Set recent blockhash and fee payer
            const { blockhash } = await this._client.connection.getLatestBlockhash();
            transaction.recentBlockhash = blockhash;
...
exports.IdlLoader = IdlLoader;
exports.KNOWN_IDL_HASHES = KNOWN_IDL_HASHES;
exports.McpAPI = McpAPI;
exports.NetworkError = NetworkError;
exports.PROGRAM_IDS = PROGRAM_IDS;
exports.PayAsYouGoFlow = PayAsYouGoFlow;
exports.PaymentError = PaymentError;
exports.PrepaymentFlow = PrepaymentFlow;
exports.ProgramError = ProgramError;
exports.RegistryError = RegistryError;
exports.SdkError = SdkError;
exports.SolanaAIRegistriesSDK = SolanaAIRegistriesSDK;
exports.SolanaClient = SolanaClient;
exports.StreamPaymentFlow = StreamPaymentFlow;
exports.TOKEN_MINTS = TOKEN_MINTS;
exports.TransactionError = TransactionError;
exports.ValidationError = ValidationError;
exports.Validator = Validator;
exports.createSdk = createSdk;
exports.loadIdlForNetwork = loadIdlForNetwork;

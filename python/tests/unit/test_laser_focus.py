...
class TestDirectLineCoverage:
    ...
    def test_all_enum_values_comprehensive(self):
        ...
        mcp_statuses = [
            ...
            McpServerStatus.DEREGISTERED,
        ]
        payment_types = [
            PaymentType.PREPAY,
            PaymentType.PAY_AS_YOU_GO,
            PaymentType.PAY_PER_USAGE,
            PaymentType.STREAM,
        ]
        payment_statuses = [
    ...
    def test_error_boundary_conditions(self):
        ...
        with pytest.raises(ValueError, match="Maximum 5 tags"):
            AgentSkill(skill_id="test", name="Test Skill", tags=["tag"] * 6)
    ...
    def test_from_account_data_comprehensive(self):
        ...
        agent_data = {
            ...
            "skills": [
                ...
                {"skill_id": "image_gen", "name": "Image Generation"},
            ],

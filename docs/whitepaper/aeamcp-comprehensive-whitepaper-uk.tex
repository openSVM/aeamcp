...
\title{Мережа AEA: Комплексна децентралізована система реєстру для автономних економічних агентів та серверів протоколу контексту моделі на Solana}
...
\begin{abstract}
Поява автономних економічних агентів та застосувань великих мовних моделей (LLM) створила нагальну потребу в децентралізованій інфраструктурі виявлення та верифікації, яка може працювати в масштабі, зберігаючи безпеку та економічну стійкість. Ця комплексна робота представляє AEA Network (Мережа автономних економічних агентів), систему реєстрації в блокчейні, побудовану на блокчейні Solana, яка забезпечує безпечну, масштабовану та економічно стимульовану реєстрацію ШІ-агентів та серверів Model Context Protocol (MCP).

Наша система впроваджує нові механізми для верифікації агентів, відстеження репутації та економічних взаємодій через складну модель подвійного токена (\textbf{AEA}/\textbf{SVMAI}), комплексну архітектуру безпеки з множинними циклами аудиту\footnote{Детальні звіти аудиту доступні за адресою: \url{https://github.com/openSVM/aeamcp/tree/main/docs/audits}}, та нативну оптимізацію Solana. Реалізація включає гібридну оптимізацію зберігання даних, подієво-керовану архітектуру, Program Derived Addresses (PDA) для детерміністичного управління акаунтами та комплексні заходи безпеки, що досягають відповідності промисловим стандартам протоколу зі специфікаціями A2A, AEA та MCP.

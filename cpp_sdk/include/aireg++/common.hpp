/**
 * @file common.hpp
 * @brief Common utilities, types, and error handling for the Solana AI Registries C++ SDK
 * 
...
public:
     ...
     */
    bool operator!=(const PublicKey& other) const noexcept { return !(*this == other); }

...
using TransactionBuilderPtr = std::unique_ptr<aireg_transaction_builder_t, TransactionBuilderDeleter>;
...
using AccountInfoPtr = std::unique_ptr<aireg_account_info_t, AccountInfoDeleter>;
using TransactionResultPtr = std::unique_ptr<aireg_transaction_result_t, TransactionResultDeleter>;
using AgentInfoPtr = std::unique_ptr<aireg_agent_info_t, AgentInfoDeleter>;
using McpServerInfoPtr = std::unique_ptr<aireg_mcp_server_info_t, McpServerInfoDeleter>;
using PaymentInfoPtr = std::unique_ptr<aireg_payment_info_t, PaymentInfoDeleter>;
using BalanceInfoPtr = std::unique_ptr<aireg_balance_info_t, BalanceInfoDeleter>;

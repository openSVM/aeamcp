...
struct McpSearchFilters {
    ...
    std::optional<std::vector<McpCapability>> capabilities; ///< Filter by capabilities
...
public:
     ...
     */
    std::vector<McpServerInfo> search_servers(const McpSearchFilters& filters = {},
                                             size_t limit = 100,
                                             size_t offset = 0);
     ...
     */
    static void validate_endpoint(McpProtocol protocol, const std::string& endpoint);

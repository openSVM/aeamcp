...
aireg_client_t *aireg_client_create(const char *rpc_url, uint32_t cluster) {
  ...
  aireg_client_t *client =
      static_cast<aireg_client_t *>(malloc(sizeof(aireg_client_t)));
  if (!client) {
    return nullptr;
  }
...
aireg_transaction_builder_create(aireg_client_t *client) {
  ...
  aireg_transaction_builder_t *builder =
      static_cast<aireg_transaction_builder_t *>(
...
aireg_agent_t *aireg_agent_create(aireg_client_t *client) {
  ...
  aireg_agent_t *agent =
      static_cast<aireg_agent_t *>(malloc(sizeof(aireg_agent_t)));
  if (!agent) {
    return nullptr;
  }
...
aireg_payments_t *aireg_payments_create(aireg_client_t *client) {
  ...
  aireg_payments_t *payments =
      static_cast<aireg_payments_t *>(malloc(sizeof(aireg_payments_t)));
  if (!payments) {
    return nullptr;
  }
...
aireg_account_info_t *aireg_account_info_create(void) {
  aireg_account_info_t *info =
      static_cast<aireg_account_info_t *>(malloc(sizeof(aireg_account_info_t)));
  if (!info) {
    return nullptr;
  }
...
aireg_transaction_result_t *aireg_transaction_result_create(void) {
  aireg_transaction_result_t *result =
      static_cast<aireg_transaction_result_t *>(
...
aireg_agent_info_t *aireg_agent_info_create(void) {
  aireg_agent_info_t *info =
      static_cast<aireg_agent_info_t *>(malloc(sizeof(aireg_agent_info_t)));
  if (!info) {
    return nullptr;
  }
...
aireg_payment_info_t *aireg_payment_info_create(void) {
  aireg_payment_info_t *info =
      static_cast<aireg_payment_info_t *>(malloc(sizeof(aireg_payment_info_t)));
  if (!info) {
    return nullptr;
  }
...
aireg_balance_info_t *aireg_balance_info_create(void) {
  aireg_balance_info_t *info =
      static_cast<aireg_balance_info_t *>(malloc(sizeof(aireg_balance_info_t)));
  if (!info) {
    return nullptr;
  }

...
int main() {
    try {
        ...
        std::cout << "HTTP: " << Mcp::protocol_to_string(McpProtocol::Http) << std::endl;
        std::cout << "WebSocket: " << Mcp::protocol_to_string(McpProtocol::WebSocket) << std::endl;
        std::cout << "Stdio: " << Mcp::protocol_to_string(McpProtocol::Stdio) << std::endl;
        
        std::cout << "\n3. Testing capability conversions..." << std::endl;
        std::cout << "Resources: " << Mcp::capability_to_string(McpCapability::Resources) << std::endl;
        std::cout << "Tools: " << Mcp::capability_to_string(McpCapability::Tools) << std::endl;
        std::cout << "Prompts: " << Mcp::capability_to_string(McpCapability::Prompts) << std::endl;
        
        std::cout << "\nMCP operations example completed successfully!" << std::endl;

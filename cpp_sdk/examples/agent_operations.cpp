    ...
    try {
        ...
        for (const auto& agent_info : agents) {
            ...
            if (agent_info.pricing_model == PricingModel::PerRequest) {
                std::cout << "    Price: " << agent_info.price_per_request << " lamports/request" << std::endl;
            }
        ...
        valid_params.capabilities = {AgentCapability::TextGeneration, AgentCapability::CodeGeneration};
        ...
        try {
            ...
            std::cout << "  ✗ Invalid parameters incorrectly passed validation" << std::endl;
        } catch (const std::exception& e) {
            std::cout << "  ✓ Invalid parameters correctly rejected: " << e.what() << std::endl;
        }
        ...
        std::cout << "Found " << image_agents.size() << " image generation agents" << std::endl;
        ...
        std::cout << "Found " << tagged_agents.size() << " agents with AI/ML tags" << std::endl;
        
        // Demonstrate capability and pricing model conversions
        std::cout << "\n4. Testing capability and pricing model conversions..." << std::endl;
        ...
        std::cout << "\nAgent operations example completed successfully!" << std::endl;

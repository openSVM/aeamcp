...
use solana_ai_registries::{
    ...
    payments::{
        pyg::{PygPaymentClient, PygPaymentArgs, PygServiceType, estimate_pyg_cost},
        common::{convert_a2ampl_to_base_units, MIN_SERVICE_FEE, MIN_TOOL_FEE, A2AMPL_BASE_UNIT},
    },
};
use solana_sdk::{
...
fn test_balance_tracking_simulation() {
    ...
    let payment2 = estimate_pyg_cost(
        MIN_TOOL_FEE,
        Some(130),
        Some(3000),
        Some(75)
